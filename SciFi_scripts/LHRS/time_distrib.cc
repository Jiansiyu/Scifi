...
void time_distrib(Int_t runnum=-1){
  ...
  ctime[0]->Print("Rsf_time_distrib.pdf(","pdf");
  ctime[1]->Print("Rsf_time_distrib.pdf","pdf");
  ctime[2]->Print("Rsf_time_distrib.pdf","pdf");
  ctime[3]->Print("Rsf_time_distrib.pdf","pdf");
  ctime[4]->Print("Rsf_time_distrib.pdf","pdf");
  ctime[5]->Print("Rsf_time_distrib.pdf","pdf");
