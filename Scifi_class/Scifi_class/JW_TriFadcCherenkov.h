...
class TriFadcCherenkov : public THaPidDetector {
  // should be generic non-tracking detector 
  
  //JW : no Init() funciton, could just be inherited from THaPidDetector
  // ... actually inherited eventually from THaAnalysisObject in which Init()
  // calls ReadDatabse() and DefineVariables() which are overridden here
