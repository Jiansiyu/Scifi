...
void vdct0_Left(int run) {
    ...
    vdct0->Calibrate(T,1,"(th.evtypebits>>1)&1",plotname);
    ...
    TH1F* hFrame = c1->DrawFrame(0,0,GmpVDCt0Calib::GetNumberOfWiresPerPlane(),1000,"VDC t0 calibration reuslt;Wire number;Time offset (TDC channel)");
