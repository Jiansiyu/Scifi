...
//  T->Add(Form("/chafs1/work1/tritium/Rootfiles/tritium_%d*.root",run_number));
  ...
  Double_t lfgain;
  ofstream myfile;
  myfile.open("R_s0_ped.txt");//,fstream::app);
  ...
  c1->Divide(2,1);
    c1->cd(1);
    TH1F *tt1 = new TH1F("tt1","FADC R.s0.la",400,6000,9500);
    T->Draw("R.s0.la>>tt1",tritype);
    tt1->SetXTitle("R.s0.la");
    tt1->GetXaxis()->SetRangeUser(7000,7500);
    ...
    tt1->GetXaxis()->SetRangeUser(6000,9500);
  ...
  Double_t fscale=100;
    c1->cd(2);
    TH1F *tt2 = new TH1F("tt2","FADC Rs0.la_p",400,-200,3000);
    ...
    lfgain=900*1.0/landau->GetParameter(1);
    //gPad->SetLogy();
  ...
  TCanvas *c2 = new TCanvas("c2","c2",1200,1200);
    c2->Divide(2,1);
    c2->cd(1);
    TH1F *tt3 = new TH1F("tt3","FbusR.s0_la",200,200,2800);
    T->Draw("FbusR.s0.la>>tt3",tritype);
    tt3->SetXTitle("FbusR.s0.la");
    ...
    c2->cd(2);
    TH1F *tt7 = new TH1F("tt7","FbusR.s0_la",100,500,800);
    T->Draw("FbusR.s0.la>>tt7",tritype);
    tt7->SetXTitle("FbusR.s0.la");
    ...
    //gPad->SetLogy();
//    tt3->Draw();
    Double_t gain=550*1.0/(dpk-ped_val);
...
//    l1->SetLineColor(2);
 ...
 //w   cout << "Lcer" << i << endl;
  ...
  c3->Divide(2,1);
    c3->cd(1);
    TH1F *tt4 = new TH1F("tt4","FADC R.s0.ra",400,6000,9500);
    T->Draw("R.s0.ra>>tt4",tritype);
    tt4->SetXTitle("R.s0.ra");
    tt4->GetXaxis()->SetRangeUser(6000,6900);
    ...
    tt4->GetXaxis()->SetRangeUser(6000,9500);
   // gPad->SetLogy();
    myfile<<"s0ra"<<endl;
    myfile<<"ped: "<<ped_val <<endl;
    myfile<<"ped wid: "<< ped_wid <<endl;
    ...
    c3->cd(2);
    TH1F *tt5 = new TH1F("tt5","FADC R.s0.ra_p",250,-200,3000);
  ...
  TCanvas *c4 = new TCanvas("c4","c4",1200,1200);
    c4->Divide(2,1);
    c4->cd(1);
    TH1F *tt6 = new TH1F("tt6","FBusRs0_ra",120,200,2000);
    T->Draw("FbusR.s0.ra>>tt6",tritype);
    tt6->SetXTitle("FbusR.s0.ra");
    ...
    c4->cd(2);
    TH1F *tt8 = new TH1F("tt8","FBusRs0_ra",100,300,600);
    T->Draw("FbusR.s0.ra>>tt8",tritype);
