void plot_Raster()
{
     TFile *f1 = new TFile("/adaqfs/home/a-onl/tritium_work/MARANAL0/replay/Rootfiles/tritium_2273.root");
     //TFile *f1 = new TFile("/chafs2/work1/triton/hanjie/Rootfiles/tritium_2274.root");
     TFile *f2 = new TFile("/adaqfs/home/a-onl/tritium_work/MARANAL0/replay/Rootfiles/tritium_2209.root");
     ...
     c1->Divide(2,2);
     c1->cd(1);
     TH1F *hp1=new TH1F("hp1","Lrb.Raster.rawcur.x",500,50000,95000);
     T2->Draw("Lrb.Raster.rawcur.x>>hp1",trip);
     hp1->SetLineColor(4);
     ...
     TH1F *hp2=new TH1F("hp2","Lrb.Raster.rawcur.x",500,50000,95000);
     T1->Draw("Lrb.Raster.rawcur.x>>hp2",trip,"same");
     hp2->SetLineColor(2);
